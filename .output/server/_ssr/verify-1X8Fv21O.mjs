...
import { C as CircleCheckBig, O as Award, c as ShieldCheck, i as User, m as Mail, p as MapPin, u as ScanFace } from "../_libs/lucide-react.mjs";
import { t as AuthLayout } from "./AuthLayout-PU1ron0f.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify-1X8Fv21O.js
...
function VerifyPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthLayout, {
		...
		subtitle: step === "profile" ? "Confirm your demographic details fetched from the NIMC database." : step === "biometric" ? "Align your face in the frame. Processing happens on-device." : `Enter the 6-digit code we sent to ${email}.`,
		children: [
			step === "otp" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: "inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-dark disabled:cursor-not-allowed disabled:opacity-60",
