...
import { t as Route$12 } from "./vote._id-BZJY8k5B.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-rtAsq4MA.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DyK8XBY0.css";
...
var Route$11 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Secure, inclusive, and transparent remote voting. Empowering every eligible Nigerian to cast their ballot from anywhere with uncompromising integrity."
			},
			{
				property: "og:title",
				content: "RemoteVote NG | The Future of Nigerian Democracy"
			},
			{
...
var $$splitComponentImporter$9 = () => import("./verify-DcWTpsMk.mjs");
