...
import { n as getSession } from "./mock-store-ibCr2NBF.mjs";
import { S as CircleCheck, c as ShieldCheck, k as ArrowLeft, l as Search, t as X } from "../_libs/lucide-react.mjs";
import { t as AppHeader } from "./AppHeader-TuSVeVrd.mjs";
import { t as Route } from "./vote._id-BfGHFkU2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/vote._id-cmb36oSc.js
...
function VotePage() {
	...
	const parties = (0, import_react.useMemo)(() => Array.from(new Set(candidates.map((c) => c.party_abbr))), [candidates]);
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-6 flex flex-col gap-3 rounded-xl border border-border bg-card p-3 shadow-sm sm:flex-row sm:items-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterChip, {
								...
								children: "All"
							}), parties.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilterChip, {
					...
					!alreadyVoted && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "sticky bottom-4 mt-8",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mx-auto flex max-w-2xl items-center justify-between gap-3 rounded-2xl border border-border bg-card/95 p-3 pl-4 shadow-lg backdrop-blur",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm",
								children: selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Selected: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-semibold text-brand-dark",
									children: candidates.find((c) => c.id === selected)?.name
								})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-muted-foreground",
									children: "Select a candidate to continue"
								})
